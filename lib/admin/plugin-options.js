...
(function($){
	...
	/** Options Tabs */
	function kamnIconListOptionsTabs() {
		
		var relid = $.cookie( 'kamn_iconlist_tab_relid' );
		
		if( relid >= 1  ) {
			kamnIconListOptionsTabControl( relid );
		} else {
			kamnIconListOptionsTabControl( 0 );
		}
		
		$( '.kamn-iconlist-group-tab-link-a' ).click( function() {
			
			relid = $(this).attr( 'data-rel' );
			$.cookie( 'kamn_iconlist_tab_relid', relid );
			kamnIconListOptionsTabControl( relid );		
	...
	function kamnIconListOptionsTabControl( relid ) {
		
		$( '.kamn-iconlist-group-tab' ).each( function() {
		...
		$( '.kamn-iconlist-group-tab-link-li' ).each( function() {
